"""
Vanilla GPT-Neo 1.3B Baseline (P100 16GB, OOM fix)
=====================================================
...
def train():
    print("=" * 60)
    print("Vanilla GPT-Neo 1.3B Baseline (OOM fix)")
    print("=" * 60)
    ...
    print(f"\nSonuçlar kaydedildi: vanilla_gptneo_results.json")
